import { ButtonInteraction, CommandInteraction, MessageActionRow, MessageButton, MessageEmbed, MessageSelectMenu, SelectMenuInteraction, Permissions, GuildMember} from "discord.js";
import { client } from "..";
...
export default class AutoRole{
    ...
    static async menuRole(interaction: SelectMenuInteraction){
		...
		interaction.values.forEach(v=>{
			switch(v){
				case "first_option": Logger.log('First option'); break;
